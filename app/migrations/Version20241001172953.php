 ...
 */
final class Version20241001172953 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('COMMENT ON COLUMN rsai_employment.start_date IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('COMMENT ON COLUMN rsai_employment.end_date IS \'(DC2Type:datetime_immutable)\'');
    }
