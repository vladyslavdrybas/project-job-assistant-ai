 ...
 */
final class Version20241012215227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rsai_interview_question ALTER hash TYPE VARCHAR(32)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rsai_job ALTER employer TYPE JSON');
        $this->addSql('ALTER TABLE rsai_job ALTER contact_person TYPE JSON');
        $this->addSql('ALTER TABLE rsai_interview_question ALTER hash TYPE VARCHAR(64)');
    }
}
