 ...
 */
final class Version20241012214657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rsai_interview_question ADD hash VARCHAR(64) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rsai_job ALTER employer TYPE JSON');
        $this->addSql('ALTER TABLE rsai_job ALTER contact_person TYPE JSON');
        $this->addSql('ALTER TABLE rsai_interview_question DROP hash');
        $this->addSql('ALTER TABLE rsai_resume ALTER personal_details TYPE JSON');
    }
}
